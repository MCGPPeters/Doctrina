...
namespace numl.Tests.MathTests
{
    ...
    {
        private readonly Matrix _test = new[,]
        {
            {1, 2, 3, 4},
            {4, 5, 6, 7},
            {7, 8, 9, 10}
        ...
        public void Matrix_Multiply_Vector_Aligned_Test()
        {
            ...
            var s1 = new Vector(new double[] {6, 15, 24})
                .ToMatrix(VectorType.Col);
            var s2 = new Vector(new double[] {12, 15, 18})
        ...
        public void Matrix_Reshape_Cols_Test()
        {
            ...
            var y = v.Reshape(5, VectorType.Col, VectorType.Col);
        ...
        public void Matrix_Reshape_Rows_Test()
        {
            ...
            var x = v.Reshape(5, VectorType.Row);
        ...
        {
            var v = new Vector(new double[] {1, 3, 2, 0});
            ...
            Vector indices;
            var m1s = m1.Sort(k => k[0], VectorType.Col, true, out indices);
        ...
        public void Matrix_Sort_Rows_Test()
        {
            ...
            var v = new Vector(new double[] {0, 3, 1, 2, 4});

            Vector indices;

            var m1s = m1.Sort(k => k[0], VectorType.Row, true, out indices);
        ...
        public void Matrix_Unshape_Test()
        {
            ...
            var x = v.Reshape(5, VectorType.Row);
            var y = v.Reshape(5, VectorType.Col);
