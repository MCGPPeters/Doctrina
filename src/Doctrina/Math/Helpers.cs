namespace Doctrina.Math
{
    ...
    public static class Helpers
    {
        ...
        /// <returns>Double.</returns>
        public static double Rescale(this double value, double scaleMin, double scaleMax, double newScaleMin,
            double newScaleMax) => (newScaleMax - newScaleMin) * (value - scaleMin) / (scaleMax - scaleMin);
        ...
        /// <returns>Double.</returns>
        public static double RunningAverage(this double value, double newValue, int n) => (value + newValue) / n;
        ...
        /// <returns>Double.</returns>
        public static double ToRadians(this double degrees) => degrees * (System.Math.PI / 180.0d);
        ...
        /// <returns>Double.</returns>
        public static double ToDegrees(this double radians) => radians * (180.0d / System.Math.PI);
    }
}